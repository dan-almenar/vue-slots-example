...
<p>(The data displayed in this block is defined in the <span class="parent">ParentComponent</span>, yet this data is subject to be changed
by data comming from the <span class="from-parent">FromParentComponent</span>...)</p>
</div>
<div class="users-list">
    ...
    <div class="content-block">
        ...
        <p>(The submit button is passed to the <span class="from-parent">FromParentComponent</span> directly from the <span class="parent">ParentComponent</span>
    ...
    <div class="content-block">
        ...
        <p>(The list of users is getting filtered by a function defined on the <span class="to-parent">ToParentComponent</span> and passed to the <span class="parent">ParentComponent</span> via the {{ '<slot>' }} tag.)</p>
